package com.example.springboot.jedis.demotest.util;
...
public class JedisUtil {
    ...
    private JedisUtil() {
        if (pool == null) {
//            String ip = ResourceUtil.getKey("192.168.31.129");
//            int port = Integer.valueOf(ResourceUtil.getKey("6379"));
//            String password = ResourceUtil.getKey("123456");
            JedisPoolConfig jedisPoolConfig = new JedisPoolConfig();

            // redis 设置了密码
            pool = new JedisPool(jedisPoolConfig, "192.168.31.129", 6379, 10000, "123456");
